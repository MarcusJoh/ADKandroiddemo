	...
	protected void onResume() {
		...
		if (accessory != null) {
			if (mUsbManager.hasPermission(accessory)) {
				// Accessoar ar inkopplad och appen har fatt rattigheter att
				// koppla upp sig mot den
				openAccessory(accessory);// ?
			} else {
				// Accessoar ar inkopplad, men appen saknar rattigheter
	...
	public void run() {
		...
		while (len >= 0) {
			try {
				...
				// G�r n�got med den data som du tar emot
